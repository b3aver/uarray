...
test_that("mfi.arules works well", {
    ...
    test.df <- data.frame(class = c(1, 0, 0, 0, 0, 1),
                          ...
                          "gene3" = c(1, 2, 3, 2, 1, 4))
    exp.mfi <- list("1" =
                    list(list(list(gene="gene1", value=1),
                              list(gene="gene2", value=2),
                              list(gene="gene3", value=1)),
                         list(list(gene="gene1", value=2),
                              list(gene="gene2", value=4),
                              list(gene="gene3", value=4))),
                    "0" =
                    list(list(list(gene="gene1", value=3),
                              list(gene="gene2", value=3),
                              list(gene="gene3", value=2)),
                         list(list(gene="gene1", value=3),
                              list(gene="gene2", value=1),
                              list(gene="gene3", value=3)),
                         list(list(gene="gene1", value=2),
                              list(gene="gene2", value=4),
                              list(gene="gene3", value=2)),
                         list(list(gene="gene1", value=1),
                              list(gene="gene2", value=1),
                              list(gene="gene3", value=1))))
    ## test mfi.arules
